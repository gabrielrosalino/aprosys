...
class Turno(models.Model):
    ...
    descricao = models.CharField(
        'Descrição do Turno', max_length=30, unique=True
    )
...
class Disciplina(models.Model):
    ...
    status = models.IntegerField(
        choices=STATUS_DISCIPLINA_CHOICES,
        default=1,
...
class TurmaDisciplina(models.Model):
    ...
    status = models.IntegerField(
        'Status', choices=STATUS, default=1, null=True, blank=False
    )
...
class Voluntario(models.Model):
    ...
    telefone_contato = models.CharField(
        'Telefone de Contato', max_length=20, blank=True
    )
    ...
    descricao_atividades = models.TextField(
        'Descrição das Atividades/Interesses', blank=True
    )
...
class Aluno(models.Model):
    ...
    nacionalidade = models.CharField(
        'Nacionalidade', max_length=50, blank=True
    )
